        ...
        static void switchChoice(int choice)
        {
            ...
            switch (choice)
            {
                case 1 :
                    ...
                    Employeemodel newEmpList[] = employeeService.create_emp(new Employeemodel(id,name,dept,sal));
                ...
                case 2 :
                    ...
                    Employeemodel updateEmp = employeeService.search_emp(updateEid);
                    if(updateEmp != null)
                    {
                        System.out.println("Enter your Choice");
                ...
                case 3 :
                    ...
                    int eid = sc.nextInt();
                    Employeemodel emp = employeeService.search_emp(eid);
                    if(emp != null)
                    {
                ...
                case 4 :
                    ...
                    Employeemodel empList[] = employeeService.employeeList();

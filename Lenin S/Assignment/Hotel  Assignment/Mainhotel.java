...
ArrayList<pojoHotelclass> data=new ArrayList<>();
System.out.println("enter how many hotels ");
	int no=s.nextInt();
	
	for(int i=0;i<no;i++)
	{
                pojoHotelclass hotel=new pojoHotelclass();
		System.out.println("enter the id,name,facility,description,ratings seperated by comma");
		String line=s.next();
                
		pojoHotelclass o=new pojoHotelclass();
		o=pojoHotelclass.createdata(line);//passing the line to createsong method
		data.add(o);

...
//add songs list:
	...
	{
		list.add(Song.createSong("Mayanadhi,melody,04:34,5.0"));
		list.add(Song.createSong("neeyaeoli,hiphop,03:22,4.1"));
		list.add(Song.createSong("custody,rock,04:10,3.0"));
		list.add(Song.createSong("pookkalpookum,classical,03:58,2.3"));
	}

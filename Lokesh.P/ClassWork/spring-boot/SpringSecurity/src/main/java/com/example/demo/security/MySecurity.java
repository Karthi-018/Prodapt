...
//		.requestMatchers("/admin").hasRole("ADMIN").requestMatchers("/customer").hasRole("CUSTOMER")
	...
	public UserDetailsService userCredentialService()
	{
		...
		UserDetails customerCredentials=User.withUsername("Customer").password(passwordEncoder().encode("12345")).roles("CUSTOMER").build();

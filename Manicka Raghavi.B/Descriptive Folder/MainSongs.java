    ...
    for(Song obj:songlist)
     { 
      if((obj.getTitle()).equals(song_name))
      {
       ...
       System.out.format("%-20s %-10s %-12s %-12s\n",obj.getTitle(),obj.getGenre(),newSimpleDateFormat("mm:ss").format(obj.getDuration()),obj.getRating());
       oos.writeObject(obj); 
...
{ 
  ...
  case 1:
         ...
         System.out.println("Sorting the Song List based on Duration"); 
  ...
  case 2: 
         ...
         System.out.println("Sorting the Song List based on Rating"); 
  ...
  case 3: 
        ...
        System.out.println("Search Song Name");

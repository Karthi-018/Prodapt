...
"4.javah command"},3);
        ...
        for(int i=0;i<10;i++)
        {
            System.out.println(q[i].questionNo+q[i].question);
            System.out.println(q[i].options[0]);
            System.out.println(q[i].options[1]);
            System.out.println(q[i].options[2]);
            System.out.println(q[i].options[3]);
